...
const Stats = ({ wpm, accuracy, extraChars, correctChars, inCorrectChars, missedChars, graphData, testTime, reset }) => {
  ...
  return (
    <>
    <ArrowBackIcon onClick={()=> reset()} style={{cursor: 'pointer', display: 'flex'}}/>
